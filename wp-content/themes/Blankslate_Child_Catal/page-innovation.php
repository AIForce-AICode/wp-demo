    ...
    <div class="container">
        ...
        <div class="card-grid">
            <div class="card tech-card tech-hover tech-scan interactive-element">
                ...
                <div style="margin-top: 20px;">
                    ...
                    <div style="display: flex; align-items: center; gap: 8px;">
                        <i class="fas fa-check-circle" style="color: var(--accent-600); font-size: 14px;"></i>
                        <span style="color: var(--primary-700); font-size: 14px;">质量标准制定</span>
                    </div>
                </div>
            </div>
            ...
            <div class="card tech-card tech-hover tech-scan interactive-element">
                ...
                <h3 class="card-title">产品设计</h3>
                <p class="card-description">从概念到产品的全流程设计开发能力</p>
                <div style="margin-top: 20px;">
                    <div style="display: flex; align-items: center; gap: 8px; margin-bottom: 8px;">
                        <i class="fas fa-check-circle" style="color: var(--accent-600); font-size: 14px;"></i>
                        <span style="color: var(--primary-700); font-size: 14px;">结构设计优化</span>
                    </div>
                    <div style="display: flex; align-items: center; gap: 8px; margin-bottom: 8px;">
                        <i class="fas fa-check-circle" style="color: var(--accent-600); font-size: 14px;"></i>
                        <span style="color: var(--primary-700); font-size: 14px;">性能仿真分析</span>
                    </div>
                    <div style="display: flex; align-items: center; gap: 8px; margin-bottom: 8px;">
                        <i class="fas fa-check-circle" style="color: var(--accent-600); font-size: 14px;"></i>
                        <span style="color: var(--primary-700); font-size: 14px;">工艺可行性评估</span>
                    </div>
                    <div style="display: flex; align-items: center; gap: 8px;">
                        <i class="fas fa-check-circle" style="color: var(--accent-600); font-size: 14px;"></i>
                        <span style="color: var(--primary-700); font-size: 14px;">成本效益分析</span>
                    </div>
                </div>
            </div>
            ...
            <div class="card tech-card tech-hover tech-scan interactive-element">
                ...
                <h3 class="card-title">测试验证</h3>
                <p class="card-description">完善的测试体系确保产品质量与性能</p>
                <div style="margin-top: 20px;">
                    <div style="display: flex; align-items: center; gap: 8px; margin-bottom: 8px;">
                        <i class="fas fa-check-circle" style="color: var(--accent-600); font-size: 14px;"></i>
                        <span style="color: var(--primary-700); font-size: 14px;">材料性能测试</span>
                    </div>
                    <div style="display: flex; align-items: center; gap: 8px; margin-bottom: 8px;">
                        <i class="fas fa-check-circle" style="color: var(--accent-600); font-size: 14px;"></i>
                        <span style="color: var(--primary-700); font-size: 14px;">EMC兼容性测试</span>
                    </div>
                    <div style="display: flex; align-items: center; gap: 8px; margin-bottom: 8px;">
                        <i class="fas fa-check-circle" style="color: var(--accent-600); font-size: 14px;"></i>
                        <span style="color: var(--primary-700); font-size: 14px;">环境适应性测试</span>
                    </div>
                    <div style="display: flex; align-items: center; gap: 8px;">
                        <i class="fas fa-check-circle" style="color: var(--accent-600); font-size: 14px;"></i>
                        <span style="color: var(--primary-700); font-size: 14px;">可靠性验证</span>
                    </div>
                </div>
            </div>
            ...
            <div class="card tech-card tech-hover tech-scan interactive-element">
                ...
                <h3 class="card-title">工艺创新</h3>
                <p class="card-description">持续的工艺改进与制造技术创新</p>
                <div style="margin-top: 20px;">
                    <div style="display: flex; align-items: center; gap: 8px; margin-bottom: 8px;">
                        <i class="fas fa-check-circle" style="color: var(--accent-600); font-size: 14px;"></i>
                        <span style="color: var(--primary-700); font-size: 14px;">生产工艺优化</span>
                    </div>
                    <div style="display: flex; align-items: center; gap: 8px; margin-bottom: 8px;">
                        <i class="fas fa-check-circle" style="color: var(--accent-600); font-size: 14px;"></i>
                        <span style="color: var(--primary-700); font-size: 14px;">自动化程度提升</span>
                    </div>
                    <div style="display: flex; align-items: center; gap: 8px; margin-bottom: 8px;">
                        <i class="fas fa-check-circle" style="color: var(--accent-600); font-size: 14px;"></i>
                        <span style="color: var(--primary-700); font-size: 14px;">良品率改善</span>
                    </div>
                    <div style="display: flex; align-items: center; gap: 8px;">
                        <i class="fas fa-check-circle" style="color: var(--accent-600); font-size: 14px;"></i>
                        <span style="color: var(--primary-700); font-size: 14px;">成本控制</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(400px, 1fr)); gap: 30px;">
            <div class="card tech-card tech-hover tech-scan interactive-element" style="padding: 30px;">
                ...
                <div style="color: var(--primary-600); font-family: monospace; font-size: 14px; margin-bottom: 15px;">CN202110123456.7</div>
            ...
            <div class="card tech-card tech-hover tech-scan interactive-element" style="padding: 30px;">
                ...
                <div style="color: var(--primary-600); font-family: monospace; font-size: 14px; margin-bottom: 15px;">CN202110234567.8</div>
            ...
            <div class="card tech-card tech-hover tech-scan interactive-element" style="padding: 30px;">
                ...
                <div style="color: var(--primary-600); font-family: monospace; font-size: 14px; margin-bottom: 15px;">CN202110345678.9</div>
            ...
            <div class="card tech-card tech-hover tech-scan interactive-element" style="padding: 30px;">
                ...
                <div style="color: var(--primary-600); font-family: monospace; font-size: 14px; margin-bottom: 15px;">CN202110456789.0</div>
                <p style="color: var(--primary-700); line-height: 1.6;">提高磁性材料充磁效率的工艺改进方法</p>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        ...
        <div style="display: flex; flex-direction: column; gap: 80px;">
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 50px; align-items: center;">
                <div>
                    <h3 style="font-size: 32px; font-weight: bold; color: var(--primary-800); margin-bottom: 25px;">高性能纳米晶带材</h3>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 50px; align-items: center;">
                <div style="order: 2;">
                    <h3 style="font-size: 32px; font-weight: bold; color: var(--primary-800); margin-bottom: 25px;">EMC解决方案</h3>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 50px; align-items: center;">
                <div>
                    <h3 style="font-size: 32px; font-weight: bold; color: var(--primary-800); margin-bottom: 25px;">智能制造系统</h3>
    ...
    <div class="container">
        ...
        <div class="card-grid">
            <div class="card tech-card tech-hover tech-scan interactive-element" style="text-align: center; padding: 25px;">
                ...
                <h3 style="font-size: 20px; font-weight: bold; color: var(--primary-800); margin-bottom: 8px;">清华大学</h3>
                <div style="color: var(--accent-600); font-weight: 600; margin-bottom: 12px;">学术合作</div>
            ...
            <div class="card tech-card tech-hover tech-scan interactive-element" style="text-align: center; padding: 25px;">
                ...
                <h3 style="font-size: 20px; font-weight: bold; color: var(--primary-800); margin-bottom: 8px;">中科院</h3>
                <div style="color: var(--accent-600); font-weight: 600; margin-bottom: 12px;">技术合作</div>
            ...
            <div class="card tech-card tech-hover tech-scan interactive-element" style="text-align: center; padding: 25px;">
                ...
                <h3 style="font-size: 20px; font-weight: bold; color: var(--primary-800); margin-bottom: 8px;">比亚迪</h3>
                <div style="color: var(--accent-600); font-weight: 600; margin-bottom: 12px;">产业合作</div>
            ...
            <div class="card tech-card tech-hover tech-scan interactive-element" style="text-align: center; padding: 25px;">
                ...
                <h3 style="font-size: 20px; font-weight: bold; color: var(--primary-800); margin-bottom: 8px;">华为</h3>
                <div style="color: var(--accent-600); font-weight: 600; margin-bottom: 12px;">产业合作</div>
                <p style="color: var(--primary-700); font-size: 14px; line-height: 1.6;">通信设备磁性元件供应</p>
            </div>
        </div>
    </div>
</section>
        ...
        <div style="display: flex; justify-content: center;">
            <div class="card tech-card tech-hover tech-scan interactive-element" style="padding: 30px; text-align: center; background: var(--primary-50); max-width: 400px;">
                <div style="width: 250px; height: 250px; margin: 0 auto 25px; background: white; border-radius: 15px; padding: 15px; box-shadow: var(--shadow-lg);">
                    ...
                    <div style="width: 100%; height: 100%; background: var(--primary-100); border-radius: 10px; display: none; flex-direction: column; align-items: center; justify-content: center; color: var(--primary-600);">
                        <i class="fas fa-qrcode" style="font-size: 60px; margin-bottom: 15px;"></i>
                        <p style="font-size: 18px; font-weight: 600;">CMR公众号</p>
                        <p style="font-size: 14px;">扫码关注</p>
                    </div>
                </div>
                <h3 style="font-size: 24px; font-weight: bold; color: var(--primary-800); margin-bottom: 12px;">CMR官方公众号</h3>
                <p style="color: var(--primary-700); line-height: 1.6; margin-bottom: 20px;">
                    关注我们获取：
                </p>
                <div style="text-align: left;">
                    <div style="display: flex; align-items: center; gap: 12px; margin-bottom: 8px;">
                        <i class="fas fa-check-circle" style="color: var(--accent-600);"></i>
                        <span style="color: var(--primary-700);">最新技术资讯</span>
                    </div>
                    <div style="display: flex; align-items: center; gap: 12px; margin-bottom: 8px;">
                        <i class="fas fa-check-circle" style="color: var(--accent-600);"></i>
                        <span style="color: var(--primary-700);">行业发展动态</span>
                    </div>
                    <div style="display: flex; align-items: center; gap: 12px; margin-bottom: 8px;">
                        <i class="fas fa-check-circle" style="color: var(--accent-600);"></i>
                        <span style="color: var(--primary-700);">产品应用案例</span>
                    </div>
                    <div style="display: flex; align-items: center; gap: 12px;">
                        <i class="fas fa-check-circle" style="color: var(--accent-600);"></i>
                        <span style="color: var(--primary-700);">专业技术解答</span>
                    </div>
                </div>
            </div>
        </div>
...
<section class="content-section tech-grid" style="background: var(--accent-600); color: white;">
    ...
    <div class="container">
        <div style="text-align: center;">
            ...
            <p style="font-size: 20px; margin-bottom: 30px; opacity: 0.9; max-width: 800px; margin-left: auto; margin-right: auto;">
